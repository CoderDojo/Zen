                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <p class="help-block">This should be different to the personal email you signed up for an account here with. For your own CoderDojo email address (Eg. <i>limerick.ie@coderdojo.com</i>), please <a href="mailto:enquiries@coderdojo.com">contact us</a> and leave this field blank.</p>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                          ...
                          <div class="controls">
                            <div class="input-prepend">
                              <input class="input-xlarge" id="website" name="website" style="width:243px" size="16" type="text" value="<?=$website['value'];?>">
                            </div>

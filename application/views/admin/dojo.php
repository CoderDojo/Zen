                ...
                <table id="vfy-dojo-table" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="https://hwf.zendesk.com/tickets/new?email=<?=urlencode($dojo->useremail);?>&ticket[set_collaborators]=<?=urlencode($dojo->dojoemail);?>&ticket[subject]=Zen%20Verification:%20<?=urlencode($dojo->name);?>&ticket[status]=pending&ticket[type]=question&ticket[priority]=normal&ticket[group_id]=21222293" target="_blank" title="Open a Ticket" style="color: #<?=$dojo->charter?'33CC33':'CC3333';?>"><?=$dojo->useremail;?></a></td>
